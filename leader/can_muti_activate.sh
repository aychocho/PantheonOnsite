...
# This rig: pin interface names to USB ports so can0/can1 never swap.
USB_PORTS["7-1.1:1.0"]="can0:1000000"  # follower arm (original adapter)
USB_PORTS["1-3:1.0"]="can1:1000000"    # leader arm (second adapter)
